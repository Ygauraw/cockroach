...
public class UnionUnitsComposite5 extends UnionUnits {

	public UnionUnitsComposite5(MathEngine mathEngine) {
		super(mathEngine);
	...
	public Queue<UnitBot> getUnionUnits() {
		...
		try {
			...
			clazz = Class.forName(BatSin.class.getName());
			...
			// MathEngine.class, Boolean.class);
			// unitBot = new UnitBot(constructor, new Object[] { new
			// PointF(Config.CAMERA_WIDTH * 0.4f, -100), mathEngine,
			// Boolean.TRUE });
			// unitBot.setDelay(2000);
			// cockroachs.add(unitBot);
			//
			...
			// MathEngine.class, Boolean.class);
			// unitBot = new UnitBot(constructor, new Object[] { new
			// PointF(Config.CAMERA_WIDTH * 0.6f, -100), mathEngine,
			// Boolean.TRUE });
			// unitBot.setDelay(2000);
			// cockroachs.add(unitBot);
